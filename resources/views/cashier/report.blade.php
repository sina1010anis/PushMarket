...
<div class="d-flex justify-content-center align-items-center my-3">
    <div class="w-75">
        @if(!isset($date))
            <p dir="rtl" class="text-center border-bottom my-f-12 my-font-IYM my-color-b-800">فاکتور های تاریخ {{jdate()->now()}}</p>
        @else
            <p dir="rtl" class="text-center border-bottom my-f-12 my-font-IYM my-color-b-800">{{$date}}</p>
        @endif
            ...
            <tbody>
                    ...
                    @foreach ($factors as $factor)
                        <tr>
                            ...
                            <td class="my-font-ISL my-f-12 my-color-b-600">{{$factor->total_price}} <span class="my-f-10 my-color-b-500 my-font-IYL">(تومان)</span></td>
                            ...
                            <td class="my-font-ISL my-f-12 my-color-b-600">
                                @foreach ($factor->products as $product)
                                    <div class="w-100  my-1 d-flex justify-content-between align-items-center border-bottom" >
                                        ...
                                        <p class="my-f-9 my-font-ISL my-color-b-600">{{$product->total_number . ' - ' . $product->total_price}} <span class="my-f-10 my-color-b-500 my-font-IYL">(تومان)</span></p>
                                    </div>
                                @endforeach
                            </td>
...
<div class="d-flex justify-content-center align-items-center my-3">
        <form action="{{route('cashier.reprot.products')}}" method="post" class="w-75 text-center border p-3">
            @csrf
            <div class="my-3">
            ...
            <div class="d-flex justify-content-center">
                <button class="btn btn-success my-font-IYL my-f-10-i btn-sm">برسی فاکتور ها</button>
            </div>
        </form>
</div>
...
<div class="d-flex justify-content-center align-items-center my-3">
        <form action="{{route('cashier.reprot.products')}}" method="post" class="w-75 text-center border p-3">
            ...
            <div class="d-flex justify-content-center">
                <button class="btn btn-success my-font-IYL my-f-10-i btn-sm">برسی فاکتورها</button>
            </div>
        </form>
</div>
