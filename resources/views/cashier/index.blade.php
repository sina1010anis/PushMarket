...
<div class="row m-0 p-0" style="height: 100vh;">
    <div class="{{($seting->find(1)->status == 1) ? 'col-8' : 'col-12'}} bg-sa-b-l" >
        <div dir="rtl" class="row bg-sa-b-l">
            <div class="col-4">
        ...
        <div class="my-3">
            <div class="w-100">
                <div v-if="first_product != null" dir="rtl" class="bo-sa-o-h bg-white rounded-2  d-flex justify-content-between align-items-center p-2 mb-2" style="height: 100px;">
                ...
                <div v-else dir="rtl" class="bo-sa-o-h rounded-2 co-sa-o-h  d-flex justify-content-center align-items-center p-2 mb-2" style="height: 100px;">

                    <span class="my-font-IYB my-f-15 text-dange">محصولی یافت نشد</span>
                </div>


                <div v-if="factor_product != null" dir="rtl" class="w-100  bo-sa-o-h rounded-2 text-danger  px-2" style="position: relative;;overflow-y: scroll;height: 300px;background-color:  rgb(246, 246, 246);border: 1px solid rgb(187, 187, 187)">
                    ...
                    <tbody>
                        <tr v-for="(item , index) in factor_product" @key="index">
                            ...
                            <td>
                                <button class="btn-r border-0 rounded-2 mx-2 p-2" @click="edit_number(item.id,'down')">-</button>
                                ...
                                <button class="btn-g border-0 rounded-2 mx-2 p-2" @click="edit_number(item.id,'up')">+</button></td>
                ...
                <div v-else dir="rtl" class="w-100 bg-danger bg-opacity-10 bo-sa-o-h rounded-2 text-danger  px-2" style="overflow-y: scroll;height: 300px;background-color:  rgb(246, 246, 246);border: 1px solid rgb(187, 187, 187)">
                    <table class="table table-striped">
                        <thead>
                      <tr>
                        <th scope="col" class="my-font-IYB-i my-f-13 my-color-b-900">ردیف</th>
                ...
                <div dir="rtl" class="bg-danger bg-opacity-10 bo-sa-o-h rounded-2 d-flex my-font-IYM my-f-15 justify-content-between align-items-center p-2 mt-2 shadow-sm" style="height: 30px;background-color:  rgb(246, 246, 246);border: 1px solid rgb(187, 187, 187)">
                    <span class=co-sa-o-h>قیمت کل:@{{(total_price != null) ? total_price : 0}} <span class="my-f-10 my-color-b-500 my-font-IYL">{{($seting->find(2)->status == 1) ? 'ریال' : 'تومان'}}</span></span>
                    <span class=co-sa-o-h>تعداد اقلام: @{{(number != null) ? number : 0}}</span>
                    <span class=co-sa-o-h>تعداد کل: @{{(total_number != null) ? total_number : 0}}</span>
                </div>
    ...
    @if ($seting->find(1)->status == 1)
        <div class="col-4 m-0 p-0" >
            <div style="background-color: #ebd5bd" class="h-50 w-100 p-3">
                <div dir="rtl" class="d-flex mb-3">
                    <span class="my-font-IYB my-f-13 co-sa-b-h my-color-b-700 ms-auto ">لیست بدهکار ها</span>
                ...
                <div class="overflow-y-scroll" style="max-height: 350px;height: 100%">
                    @foreach ($creditors as $creditor)
                        <div class="w-100 my-3 border-start-0 border-end-0 bo-sa-o-h p-2">
            ...
            <div style="background-color: #ebd5bd" class="h-25 w-100 p-3 pt-2">
                ...
                <div>
                    <div class="row">
                        <div class="col-6 p-1">
                            <input style="font-size: 12px!important;border: 1px solid #ec6b05;background-color: #ebd5bd" type="text" v-model="search_number" @keyup.enter="search_price" class="w-100 p-2  text-center mt-3 my-font-IYL my-f-11" placeholder="استعلام با بارکد محصول" dir="rtl" >
                        </div>
                        <div class="col-6 p-1">
                            <input style="font-size: 12px!important;border: 1px solid #ec6b05;background-color: #ebd5bd" type="text" v-model="search_name" @keyup.enter="search_price_by_name" class="w-100 p-2 text-center mt-3 my-font-IYL my-f-11" placeholder="استعلام با نام محصول" dir="rtl" >
                        </div>
                    </div>
            ...
            <div style="background-color: #ebd5bd" class="h-25 w-100 p-3 pt-2">
                <div dir="rtl" class="d-flex justify-content-between align-items-center">
                    <span class="my-font-IYB my-f-13 co-sa-b-h ms-auto">جدیدترین اخبار </span>
